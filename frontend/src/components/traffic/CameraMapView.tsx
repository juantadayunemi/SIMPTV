              ...
              <Popup>
                <div style={{ minWidth: '220px' }}>
                  ...
                  <div
                      ...
                      dangerouslySetInnerHTML={{ __html: getStatusBadge(camera.status) }}>
                    </div>
                  ...
                  <div style={{ marginTop: '12px', paddingTop: '12px', borderTop: '1px solid #e5e7eb' }}>
                   <button
                      ...
                      className="w-full bg-primary-500 hover:bg-primary-600 text-white py-2 px-4 rounded-button font-medium text-sm transition-colors duration-200"
                    >
                      ▶️ Reproducir
                    </button>
                  </div>
