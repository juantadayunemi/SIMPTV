                ...
                <div className="flex flex-col items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-600 mb-6">
                      ⏰ El enlace expirará en 3 minutos. Por favor confírmalo
                      de inmediato.
                    </p>
                    <button
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative mb-1">
                      ...
                      <Input
                        ...
                        className="w-full pr-10" // Añadimos padding derecho fijo
                      />
                      <button
                        type="button"
                        onClick={() =>
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 z-10" // Añadimos z-index
                      >
                        {showConfirmPassword ? (
                          <EyeOff className="text-gray-500" />
                        ) : (
