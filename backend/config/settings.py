...
if USE_S3_STORAGE:
    ...
    AWS_DEFAULT_ACL = None  # Usar ACL del bucket
    AWS_S3_FILE_OVERWRITE = False  # No sobrescribir archivos con mismo nombre
    AWS_QUERYSTRING_AUTH = True  # URLs firmadas (privadas y seguras)
    AWS_QUERYSTRING_EXPIRE = 3600  # URLs expiran en 1 hora
...
YOLO_MODEL_PATH = BASE_DIR / "models" / "yolov8n.pt"  # Nano model (fast) - Para traffic_app
YOLO_STREAMING_MODEL_PATH = BASE_DIR / "models" / "yolov8nplus.pt"  # Modelo personalizado (juguetes/Hot Wheels) - Para streaming
...
# ==============================================================================
# LIVE STREAMING DATA STORAGE (SEPARATE FROM VIDEO ANALYSIS)
# ==============================================================================

# Streaming detection data (JSON files) - SEPARATE from analysis
STREAMING_DATA_DIR = BASE_DIR / "media" / "datos streaming"

# Streaming vehicle images with detected plates - SEPARATE from analysis
STREAMING_PLACAS_DIR = BASE_DIR / "media" / "Placas Streaming"

# Streaming vehicle images without plates (rejected) - SEPARATE from analysis
STREAMING_ROI_DIR = BASE_DIR / "media" / "ROI YOLO Streaming"
...
# ============================================================================
# Configuración para grabaciones de monitoreo en tiempo real
...
# Configuración de streaming en tiempo real
...
# Redis para Django Channels (WebSocket)
REDIS_HOST = config('REDIS_HOST', default='127.0.0.1')
REDIS_PORT = config('REDIS_PORT', default=6379, cast=int)

# Directorio temporal para grabaciones antes de subir a S3
