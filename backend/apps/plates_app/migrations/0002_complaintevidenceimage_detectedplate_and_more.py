...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name="complaintevidenceimage",
            name="detectedPlateImageId",
