    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('platePattern', models.CharField(db_column='platePattern', help_text='Regex pattern for plates', max_length=50)),
                ('alertType', models.CharField(choices=[('STOLEN', 'Stolen Vehicle'), ('WANTED', 'Wanted Person'), ('VIP', 'VIP Vehicle'), ('BLACKLIST', 'Blacklisted')], db_column='alertType', max_length=20)),
                ('isActive', models.BooleanField(db_column='isActive', default=True)),
                ('createdAt', models.DateTimeField(auto_now_add=True, db_column='createdAt')),
                ('createdBy', models.ForeignKey(db_column='createdBy', on_delete=django.db.models.deletion.CASCADE, to='auth_app.user')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='platedetection',
            index=models.Index(fields=['createdAt'], name='plates_dete_created_9e67bf_idx'),
        ),
    ]
