...
from apps.predictions_app.services.prediction_service import get_speed_prediction, get_traffic_prediction
...
class SpeedPredictionView(APIView):
    """
    Endpoint: /api/predictions/speed-predictions/?locationId=<id>&date=<date>&hour=<hour>&minute=<minute>
    """
