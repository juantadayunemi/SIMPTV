...
class ModelTrainingJobEntity(BaseModel):
    ...
    id = models.CharField(max_length=50, primary_key=True, editable=False)
    modelId = models.ForeignKey('PredictionModel', on_delete=models.CASCADE, related_name='modeltrainingjobentity_model_set')
...
class TrafficPredictionEntity(BaseModel):
    ...
    id = models.CharField(max_length=50, primary_key=True, editable=False)
    modelId = models.ForeignKey('PredictionModel', on_delete=models.CASCADE, related_name='trafficpredictionentity_model_set')
...
class BatchPredictionEntity(BaseModel):
    ...
    id = models.CharField(max_length=50, primary_key=True, editable=False)
    modelId = models.ForeignKey('PredictionModel', on_delete=models.CASCADE, related_name='batchpredictionentity_model_set')
...
class PredictionAccuracyEntity(BaseModel):
    ...
    id = models.CharField(max_length=50, primary_key=True, editable=False)
    modelId = models.ForeignKey('PredictionModel', on_delete=models.CASCADE, related_name='predictionaccuracyentity_model_set')
