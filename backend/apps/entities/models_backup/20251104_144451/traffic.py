...
class VehicleComplaintDetectionEntity(BaseModel):
    ...
    trafficAnalysisId = models.ForeignKey('traffic_app.TrafficAnalysis', on_delete=models.CASCADE, related_name='vehiclecomplaintdetectionentity_trafficanalysis_set')
    vehicleId = models.ForeignKey('traffic_app.Vehicle', on_delete=models.CASCADE, related_name='vehiclecomplaintdetectionentity_vehicle_set')
    plateNumber = models.CharField(max_length=20)
    detectionConfidence = models.DecimalField(max_digits=5, decimal_places=4)
    ...
    frameNumber = models.IntegerField(blank=True, null=True)
    notes = models.TextField(blank=True, null=True)
...
class VehicleComplaintEntity(BaseModel):
    ...
    detectionId = models.ForeignKey('traffic_app.VehicleComplaintDetection', on_delete=models.CASCADE, related_name='vehiclecomplaintentity_detection_set')
...
class CreateVehicleComplaintDetectionDTO(BaseModel):
    ...
    detectionConfidence = models.IntegerField()
