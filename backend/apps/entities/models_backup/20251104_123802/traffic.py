...
class TrafficAnalysisEntity(BaseModel):
    ...
    # Plate detection fields
    platesDetected = models.IntegerField(
        default=0, db_column="platesDetected", help_text="Total de placas detectadas"
    )
    platesCaptured = models.IntegerField(
        default=0,
        db_column="platesCaptured",
        help_text="Total de placas capturadas con texto válido",
    )
