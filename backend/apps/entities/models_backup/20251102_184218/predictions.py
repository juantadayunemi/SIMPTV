...
class PredictionModelEntity(BaseModel):
    ...
    locationId = models.ForeignKey(
        ...
        related_name="predictionmodel_location_set",
    )
...
class TrafficPredictionEntity(BaseModel):
    ...
    modelId = models.ForeignKey(
        "PredictionModel",
        on_delete=models.CASCADE,
        related_name="trafficprediction_model_set",
    )
    locationId = models.ForeignKey(
        "traffic_app.Location",
        on_delete=models.CASCADE,
        related_name="trafficprediction_location_set",
    )
...
class BatchPredictionEntity(BaseModel):
    ...
    modelId = models.ForeignKey(
        "PredictionModel",
        on_delete=models.CASCADE,
        related_name="batchprediction_model_set",
    )
    locationId = models.ForeignKey(
        "traffic_app.Location",
        on_delete=models.CASCADE,
        related_name="batchprediction_location_set",
    )
...
class PredictionAccuracyEntity(BaseModel):
    ...
    modelId = models.ForeignKey(
        "PredictionModel",
        on_delete=models.CASCADE,
        related_name="predictionaccuracy_model_set",
    )
    locationId = models.ForeignKey(
        "traffic_app.Location",
        on_delete=models.CASCADE,
        related_name="predictionaccuracy_location_set",
    )
...
class RealTimePredictionEntity(BaseModel):
    ...
    locationId = models.ForeignKey(
        "traffic_app.Location",
        on_delete=models.CASCADE,
        related_name="realtimeprediction_location_set",
    )
...
class PredictionSourceEntity(BaseModel):
    ...
    locationId = models.ForeignKey(
        "traffic_app.Location",
        on_delete=models.CASCADE,
        related_name="predictionsource_location_set",
    )
    cameraId = models.ForeignKey(
        "traffic_app.Camera",
        on_delete=models.CASCADE,
        related_name="predictionsource_camera_set",
    )
