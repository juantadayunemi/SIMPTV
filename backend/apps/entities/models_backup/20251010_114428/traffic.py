...
class TrafficHistoricalDataEntity(BaseModel):
    ...
    dayOfWeek = models.FloatField(default=0)
    ...
    temperature = models.FloatField(default=0, blank=True, null=True)
...
class CameraEntity(BaseModel):
    ...
    fps = models.FloatField(default=0, blank=True, null=True)
...
class VehicleEntity(BaseModel):
    ...
    direction = models.CharField(
        max_length=20, choices=TRAFFIC_DIRECTION_CHOICES, blank=True, null=True
    )
    ...
    brand = models.CharField(max_length=255, blank=True, null=True)
    model = models.CharField(max_length=255, blank=True, null=True)
    plateProcessingStatus = models.CharField(
        max_length=20, choices=PLATE_PROCESSING_STATUS_CHOICES
    )
    bestFrameForPlate = models.FloatField(default=0, blank=True, null=True)
...
class TrafficAnalysisSearchQuery(BaseModel):
    ...
    status = models.CharField(
        max_length=20, choices=ANALYSIS_STATUS_CHOICES, blank=True, null=True
    )
    densityLevel = models.CharField(
        max_length=10, choices=DENSITY_LEVELS_CHOICES, blank=True, null=True
    )
    vehicleCountMin = models.FloatField(default=0, blank=True, null=True)
    vehicleCountMax = models.FloatField(default=0, blank=True, null=True)
...
class VehicleSearchQuery(BaseModel):
    ...
    trafficAnalysisId = models.UUIDField(
        default=uuid.uuid4, editable=False, blank=True, null=True
    )
    vehicleType = models.CharField(
        max_length=20, choices=VEHICLE_TYPES_CHOICES, blank=True, null=True
    )
...
class TrafficData(BaseModel):
    ...
    totalVehicles = models.FloatField(default=0)
...
class TrafficPrediction(BaseModel):
    ...
    predictedVehicles = models.FloatField(default=0)
    densityLevel = models.CharField(max_length=10, choices=DENSITY_LEVELS_CHOICES)
    confidence = models.FloatField()
...
class TrafficAnalysisDTO(BaseModel):
    ...
    peakHours = models.JSONField(default=list)
    estimatedCompletion = models.DateTimeField(
...
class CreateTrafficAnalysisRequestDTO(BaseModel):
    ...
    weatherConditions = models.CharField(max_length=255, blank=True, null=True)
    maxDuration = models.FloatField(default=0, blank=True, null=True)
    sampleRate = models.FloatField(default=0, blank=True, null=True)
...
class UpdateTrafficAnalysisRequestDTO(BaseModel):
    ...
    progress = models.FloatField(default=0, blank=True, null=True)
    errorMessage = models.CharField(max_length=255, blank=True, null=True)
    totalVehicleCount = models.FloatField(default=0, blank=True, null=True)
    avgSpeed = models.FloatField(default=0, blank=True, null=True)
    densityLevel = models.CharField(
        max_length=10, choices=DENSITY_LEVELS_CHOICES, blank=True, null=True
    )
    carCount = models.FloatField(default=0, blank=True, null=True)
    truckCount = models.FloatField(default=0, blank=True, null=True)
    motorcycleCount = models.FloatField(default=0, blank=True, null=True)
    busCount = models.FloatField(default=0, blank=True, null=True)
    bicycleCount = models.FloatField(default=0, blank=True, null=True)
    otherCount = models.FloatField(default=0, blank=True, null=True)
...
class FinalizeVehicleTrackingRequestDTO(BaseModel):
    ...
    trackingStatus = models.CharField(max_length=20, choices=TRACKING_STATUS_CHOICES)
    avgSpeed = models.FloatField(default=0, blank=True, null=True)
    finalDirection = models.CharField(
        max_length=20, choices=TRAFFIC_DIRECTION_CHOICES, blank=True, null=True
    )
    finalLane = models.FloatField(default=0, blank=True, null=True)
    color = models.CharField(max_length=255, blank=True, null=True)
    brand = models.CharField(max_length=255, blank=True, null=True)
    model = models.CharField(max_length=255, blank=True, null=True)
...
class TrafficAnalysisQueryDTO(BaseModel):
    ...
    startDate = models.DateTimeField(auto_now_add=False, blank=True, null=True)
    endDate = models.DateTimeField(auto_now_add=False, blank=True, null=True)
    minVehicleCount = models.FloatField(default=0, blank=True, null=True)
    maxVehicleCount = models.FloatField(default=0, blank=True, null=True)
...
class VehicleSearchQueryDTO(BaseModel):
    ...
    minSpeed = models.FloatField(default=0, blank=True, null=True)
    maxSpeed = models.FloatField(default=0, blank=True, null=True)
    minFrames = models.FloatField(default=0, blank=True, null=True)
    maxFrames = models.FloatField(default=0, blank=True, null=True)
    page = models.FloatField(default=0, blank=True, null=True)
    limit = models.FloatField(default=0, blank=True, null=True)
    sortBy = models.TextField(blank=True, null=True)
    sortOrder = models.TextField(blank=True, null=True)
