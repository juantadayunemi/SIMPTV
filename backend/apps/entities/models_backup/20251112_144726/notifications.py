...
class NotificationLogEntity(BaseModel):
    ...
    class Meta:
        abstract = True  # DLL model - inherit in other apps
        verbose_name = "Abstract NotificationLogEntity"
...
class NotificationBottleNeckEntity(BaseModel):
    ...
    userId = models.ForeignKey('auth_app.User', on_delete=models.CASCADE, related_name='notificationbottleneckentity_user_set')
    locationId = models.ForeignKey('traffic_app.Location', on_delete=models.CASCADE, related_name='notificationbottleneckentity_location_set')
    cameraId = models.ForeignKey('traffic_app.Camera', on_delete=models.CASCADE, related_name='notificationbottleneckentity_camera_set')
...
class NotificationBottleNeckLogEntity(BaseModel):
    ...
    notificationBottleNeckId = models.ForeignKey('notifications_app.NotificationBottleNeck', on_delete=models.CASCADE, related_name='notificationbottlenecklogentity_notificationbottleneck_set')
...
class NotificationTaskEntity(BaseModel):
    ...
    notificationBottleNeckId = models.ForeignKey('notifications_app.NotificationBottleNeck', on_delete=models.CASCADE, related_name='notificationtaskentity_notificationbottleneck_set')
