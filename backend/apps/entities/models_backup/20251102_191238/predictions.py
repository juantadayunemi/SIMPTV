...
class ModelTrainingJobEntity(BaseModelString):
    ...
    modelId = models.ForeignKey(
        "PredictionModel",
        on_delete=models.CASCADE,
        related_name="modeltrainingjobentity_model_set",
    )
...
class TrafficPredictionEntity(BaseModelString):
    ...
    modelId = models.ForeignKey(
        "PredictionModel",
        on_delete=models.CASCADE,
        related_name="trafficpredictionentity_model_set",
    )
    locationId = models.ForeignKey(
        "traffic_app.Location",
        on_delete=models.CASCADE,
        related_name="trafficpredictionentity_location_set",
    )
...
class BatchPredictionEntity(BaseModelString):
    ...
    modelId = models.ForeignKey(
        "PredictionModel",
        on_delete=models.CASCADE,
        related_name="batchpredictionentity_model_set",
    )
    locationId = models.ForeignKey(
        "traffic_app.Location",
        on_delete=models.CASCADE,
        related_name="batchpredictionentity_location_set",
    )
...
class PredictionAccuracyEntity(BaseModelString):
    ...
    modelId = models.ForeignKey(
        "PredictionModel",
        on_delete=models.CASCADE,
        related_name="predictionaccuracyentity_model_set",
    )
    locationId = models.ForeignKey(
        "traffic_app.Location",
        on_delete=models.CASCADE,
        related_name="predictionaccuracyentity_location_set",
    )
...
class RealTimePredictionEntity(BaseModelString):
    ...
    locationId = models.ForeignKey(
        "traffic_app.Location",
        on_delete=models.CASCADE,
        related_name="realtimepredictionentity_location_set",
    )
